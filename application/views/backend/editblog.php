...
<div class="row">
		...
		<div class="row">
			<div class="file-field input-field col m6 s12">
				<span class="img-center big">
								                    	<?php if($before->logoimage == "") { } else {
									                    ?><img src="<?php echo base_url('uploads')."/".$before->logoimage; ?>">
															<?php } ?>
															</span>
				<div class="btn blue darken-4">
					<span>Logo image</span>
					<input name="logoimage" type="file" multiple>
				</div>
				<div class="file-path-wrapper">
					<input class="file-path validate" type="text" placeholder="Upload one or more files" value="<?php echo set_value('logoimage',$before->image);?>">
				</div>
			</div>
		</div>
<div class="row">
